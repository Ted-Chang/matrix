...
tools/make_initrd bin/init init bin/crond crond bin/echo echo bin/unit_test unit_test bin/ls ls bin/cat cat bin/clear clear bin/shutdown shutdown bin/crontab crontab bin/initrd
