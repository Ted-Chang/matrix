...
$tool_path bin/init init bin/crond crond bin/echo echo bin/unit_test unit_test bin/ls ls bin/cat cat bin/clear clear bin/shutdown shutdown bin/mkdir mkdir bin/date date bin/mount mount bin/umount umount bin/crond crond bin/initrd
