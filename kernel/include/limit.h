...
#define LONG_MIN	(-2147483647-1L)	/* Min value of a "long int" */
...
#ifndef MAX_INPUT
#define MAX_INPUT	512		/* Max size of char input buffer */
#endif
...
/*
 * POSIX conformance definitions - An implementation may define 
...
#define _POSIX_THREAD_DESTRUCTOR_INTERACTION	4
#define _POSIX_THREAD_KEYS_MAX		128
#define _POSIX_THREAD_THREADS_MAX	64
#define _POSIX_TTY_NAME_MAX		9

/*
 * POSIX.2 and XPG4-XSH4 conformance definitions
 */
...
#define LINE_MAX			_POSIX_LINK_MAX
...
#endif	/* defined(_EXTENSIONS__) || (__STDC__ - 0 == 0 && ...) */

#if defined(__EXTENSIONS__) || (__STDC__ - 0 == 0 && \
	!defined(_POSIX_C_SOURCE) && !defined(_XOPEN_SOURCE))

#define FCHR_MAX	1048576	/* Max size of a file in bytes */
#define PID_MAX		30000	/* Max value of a process ID */
